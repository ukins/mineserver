...
People::People()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:CPFS.People)
}
...
People::People(const People& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:CPFS.People)
}
...
People::~People() {
  // @@protoc_insertion_point(destructor:CPFS.People)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:CPFS.People)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:CPFS.People)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:CPFS.People)
  return false;
#undef DO_
}
...
void People::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:CPFS.People)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:CPFS.People)
}

::google::protobuf::uint8* People::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:CPFS.People)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:CPFS.People)
  return target;
}
