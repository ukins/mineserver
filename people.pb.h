...
inline const ::std::string& People::name() const {
  // @@protoc_insertion_point(field_get:CPFS.People.name)
  return *name_;
}
inline void People::set_name(const ::std::string& value) {
  ...
  name_->assign(value);
  // @@protoc_insertion_point(field_set:CPFS.People.name)
}
inline void People::set_name(const char* value) {
  ...
  name_->assign(value);
  // @@protoc_insertion_point(field_set_char:CPFS.People.name)
}
inline void People::set_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:CPFS.People.name)
}
inline ::std::string* People::mutable_name() {
  ...
  // @@protoc_insertion_point(field_mutable:CPFS.People.name)
  return name_;
}
...
inline void People::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:CPFS.People.name)
}
...
inline ::google::protobuf::int32 People::id() const {
  // @@protoc_insertion_point(field_get:CPFS.People.id)
  return id_;
}
inline void People::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:CPFS.People.id)
}
...
inline const ::std::string& People::email() const {
  // @@protoc_insertion_point(field_get:CPFS.People.email)
  return *email_;
}
inline void People::set_email(const ::std::string& value) {
  ...
  email_->assign(value);
  // @@protoc_insertion_point(field_set:CPFS.People.email)
}
inline void People::set_email(const char* value) {
  ...
  email_->assign(value);
  // @@protoc_insertion_point(field_set_char:CPFS.People.email)
}
inline void People::set_email(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:CPFS.People.email)
}
inline ::std::string* People::mutable_email() {
  ...
  // @@protoc_insertion_point(field_mutable:CPFS.People.email)
  return email_;
}
...
inline void People::set_allocated_email(::std::string* email) {
  ...
  // @@protoc_insertion_point(field_set_allocated:CPFS.People.email)
}
